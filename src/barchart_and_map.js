	...
	barchart_and_map: function barchart_and_map(id, indx)
{
        ...
        if (buildChart ) {
            $.getJSON(dataLocation + "region.json", function (data) {
                ...
                if (data["scenarios"][scenario].visualizations != undefined) {
                    if (data["scenarios"][scenario].visualizations["BarMap"][indx].file) {
                        fileName = data["scenarios"][scenario].visualizations["BarMap"][indx].file;
    ...
    function setDataSpecificDOM() {
        d3.selectAll("#" + id + "-div .mode-share-by-county-area-type").html(countyColumn);
        d3.selectAll("#" + id + "-div .mode-share-by-county-trip-mode-zones").html("Zones");
        d3.selectAll("#" + id + "-div .mode-share-by-county-trip-mode").html(modeColumn);
        d3.selectAll("#" + id + "-div .mode-share-by-county-trip-mode-bubbles").html("Bubbles");
        d3.selectAll("#" + id + "-div .mode-share-by-county-trip-mode-example").html(modes[0]);
        modes.forEach(function (modeName) {
            $("#" + id + "-current-trip-mode-zones").append("<option>" + modeName + "</option>");
            $("#" + id + "-current-trip-mode-bubbles").append("<option>" + modeName + "</option>");
        });
        ...
        nv.addGraph({
            generate: function chartGenerator() {
                ...
                nvd3Chart.x(function (d, i) {
                    ...
                    top: marginTop,
                    bottom: marginBottom
                }).id(id + "-multiBarHorizontalChart").stacked(true).showControls(false);
    ...
    function initializeMuchOfUI() {
        ...
        if (showCycleTools == false) {
            ...
            $('#' + id + '-cycle-frequency').closest('div').hide();
        }
        ...
        ;
        if ($("#" + id + "-classification").val() != "custom" && showCycleTools == false) {
            $('#' + id + '-slider').hide();
        }
        ...
        function cycleTripMode() {
            ...
            if (currentCycleModeIndex >= $("#" + id + "-current-trip-mode-zones option").size()) {
                currentCycleModeIndex = 0;
            }
            if (cycleGoing) {
        ...
        //end cycleTripMode
        $("#" + id + "-cycle-frequency").change(function () { //no need to do anything since cycleTripMode always reads the current #cycle-frequency
        });
        ...
        $("#" + id + "-slider").slider({
            ...
            create: function (event, ui) {
                ...
                $('#' + id + '-div .ui-slider-handle:first').html('<div class="tooltip top slider-tip"><div class="tooltip-arrow"></div><div class="tooltip-inner">' + handlers[0] + '</div></div>');
                $('#' + id + '-div .ui-slider-handle:eq(1)').html('<div class="tooltip top slider-tip"><div class="tooltip-arrow"></div><div class="tooltip-inner">' + handlers[1] + '</div></div>');
                $('#' + id + '-div .ui-slider-handle:last').html('<div class="tooltip top slider-tip"><div class="tooltip-arrow"></div><div class="tooltip-inner">' + handlers[2] + '</div></div>');
            },
            slide: function (event, ui) {
                var themax = $("#mode-share-by-county-slider").slider("option", "max");
                updateColors(ui.values, themax);
                $('#' + id + '-div .ui-slider-handle:first').html('<div class="tooltip top slider-tip"><div class="tooltip-arrow"></div><div class="tooltip-inner">' + ui.values[0] + '</div></div>');
                $('#' + id + '-div .ui-slider-handle:eq(1)').html('<div class="tooltip top slider-tip"><div class="tooltip-arrow"></div><div class="tooltip-inner">' + ui.values[1] + '</div></div>');
                $('#' + id + '-div .ui-slider-handle:last').html('<div class="tooltip top slider-tip"><div class="tooltip-arrow"></div><div class="tooltip-inner">' + ui.values[2] + '</div></div>');
            }
        });
        ...
        if (classification == "custom") {
            ...
            $("#" + id + "-slider").slider({
                ...
                start: function (event, ui) {
                    $('#' + id + '-div .ui-slider-handle:first').html('<div class="tooltip top slider-tip"><div class="tooltip-arrow"></div><div class="tooltip-inner">' + newValues[0] + '</div></div>');
                    $('#' + id + '-div .ui-slider-handle:eq(1)').html('<div class="tooltip top slider-tip"><div class="tooltip-arrow"></div><div class="tooltip-inner">' + newValues[1] + '</div></div>');
                    $('#' + id + '-div .ui-slider-handle:last').html('<div class="tooltip top slider-tip"><div class="tooltip-arrow"></div><div class="tooltip-inner">' + newValues[2] + '</div></div>');
                }
            });
